        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 text-[#c5a880]">
            ...
            <span className="font-sans text-xs font-bold uppercase tracking-[0.25em]">
              timeless traditions of Indian percussion
            </span>
          </div>
          ...
          <p className="font-sans font-light text-sm sm:text-base text-neutral-200 max-w-3xl mx-auto leading-relaxed drop-shadow-xs">
